...
export const VendorNotificationsDropdown = () => {
    ...
    const { data, isLoading } = useGetVendorNotifications({ page: String(page), item_per_page: String(ITEMS_PER_PAGE) })
    const { data: messagesCount, isLoading: isLoadingMessagesCount } = useGetVendorNotifications({ component: "count" })
    const { data: unreadMessagesCount, isLoading: isLoadingUnreadMessages } = useGetVendorNotifications({ component: "count-unread" })
    ...
    return (
        ...
        <Popover>
            ...
            <PopoverContent className="p-0! w-100 origin-top-right gap-0 max-h-149.5" align="end" sideOffset={8}>
                ...
                {
                    (isLoading || isLoadingMessagesCount || isLoadingUnreadMessages || !data) ? (
