...
export const DiscoverFoods = () => {
    ...
    return (
        <section id="see-other-cooks" className="relative isolate bg-red-5 overflow-hidden">
            <Content>
                <div className="flex flex-col gap-7">
                    <div className="grid gap-2">
                        <h2 className="font-sora text-grey-dark-0 font-extrabold text-base md:text-xl lg:text-2xl xl:text-[2.5rem] leading-12">Discover Foods</h2>
                        <p className="text-bas text-grey-dark-2">Curated meals and cooks based on location and popularity.</p>
                    </div>
                    {
                        isLoading ? (
