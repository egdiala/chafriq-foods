...
export const OrderItem = ({ item }: Props) => {   
    ...
    return (
        <>
        <div className="flex items-center gap-4 rounded-lg bg-grey-dark-4/80 p-3 relative">
            ...
            <div className="grid gap-2">
                <Link href={`/meals/${item.menu_id}`} className="font-medium text-xs text-grey-dark-2 isolate hover:underline">{item.menu_name}</Link>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden sm:flex text-2xs text-right text-grey-dark-2 whitespace-nowrap">
