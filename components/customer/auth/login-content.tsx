    ...
    return (
        <form className="flex flex-col gap-12.5 w-full max-w-100.5 mx-auto" onSubmit={(e) => {
            ...
            <div className="text-center space-y-3 w-full max-w-153 mx-auto">
                ...
                <p className="text-sm text-grey-dark-3">Don’t have an account? <Link href="/customer/register" className="font-medium text-grey-dark-0 hover:underline hover:underline-offset-1">Signup</Link></p>
            </div>
                    ...
                    {(field) => {
                        ...
                        return (
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="/customer/forgot-password" className="shrink-0 font-medium text-sm text-grey-dark-0 hover:underline hover:underline-offset-1">
                                    Forgotten Password?
                                </Link>
                            </div>
                        )
