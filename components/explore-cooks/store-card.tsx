        ...
        <div className="flex flex-col gap-3 p-3 sm:p-5 rounded-2xl inset-ring-1 inset-ring-outline isolate h-fit">
            ...
            <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                    <h3 className="text-sm sm:text-base font-semibold text-grey-dark-0">Tunji Adams</h3>
                ...
                <div className="flex items-start gap-1">
                    ...
                    <span className="text-sm text-grey-dark-2 flex-1">4517 Washington Ave. Manchester, Kentucky 39495</span>
                </div>
            </div>
        </div>
    )
