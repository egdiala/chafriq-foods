...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn("mb-4 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-xs text-orange-2 uppercase", className)}
      {...props}
    />
  )
}
...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "has-data-checked:bg-primary/5 has-data-checked:border-primary/30 dark:has-data-checked:border-primary/20 dark:has-data-checked:bg-primary/10 gap-2 text-xs text-grey-dark-2 font-normal group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-xl has-[>[data-slot=field]]:border *:data-[slot=field]:p-4 group/field-label peer/field-label flex w-fit leading-snug",
