...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn("rounded-none border-0 bg-transparent shadow-none ring-0 focus-visible:ring-0 border-transparent aria-invalid:ring-0 dark:bg-transparent flex-1", className)}
      {...props}
    />
  )
}
